...
def get_argparse():
    ...
    # Required parameters
    parser.add_argument("--task_name", default = 'jdner', type = str,
                        help = "The name of the task to train selected in the list: ")
    parser.add_argument("--data_dir", default = 'data/train_data', type = str,
                        help = "The input data dir. Should contain the training files for the CoNLL-2003 NER task.", )
    parser.add_argument("--model_type", default = 'bert', type = str,
                        help = "Model type selected in the list: ")
    parser.add_argument("--model_name_or_path", default = 'bert/bert_base_chinese', type = str,
    ...
    parser.add_argument("--predict_checkpoints", type = int, default = 50,
    ...
    parser.add_argument("--local_rank", type = int, default = -1,
                        help = "For distributed training: local_rank")  # 分布式训练
